		...
		<div class="content-wrapper">
			<div class="container-xxl flex-grow-1 container-p-y">
				...
				<div class="card">
                  ...
                  <form id="myForm" action="<c:url value='/admin_timkiem_duandabaocao_theoquynam_post?action=timkiem_duandabaocao_theoquynam_post'/>"  method="post">
					  <div class="card-body">
                              <div class="row gx-3 gy-2 align-items-center">
							...
							<thead class="table-dark">
								<tr>
									...
									<th class="text-white">ID</th>
									 ...
									 <th class="ppost_chuduan text-white">Chủ dự án</th>
                                        <th class="ppost_thuockhoa text-white">Đơn vị trực thuộc</th>
										<th class="ppost_thuocdanhmuc text-white">Danh mục</th>
								     	<th class="ppost_tenduan_tiengviet text-white">Tên dự án(TV)</th>
										<th class="ppost_tenduan_tienganh text-white">Tên dự án(TA)</th>
									   
									    <th class="ppost_muctieuduan text-white">Mục tiêu dự án</th>
									    <th class="ppost_noidungthuchien text-white">Nội dung thực hiện</th>
									    <th class="ppost_thietbitaitro text-white">Thiết bị được tài trợ</th>
									    <th class="ppost_thoigianthuchien text-white">Thời gian thực hiện</th>
									    <th class="ppost_thoigianbatdau text-white">Thời gian bắt đầu</th>
									    <th class="ppost_thoigianketthuc text-white">Thời gian kết thúc</th>
									    ...
									    <th class="ppost_kinhphiduannamroi text-white">Kinh phí dự án năm trước</th>
										<th class="ppost_nhataitro text-white">Nhà tài trợ</th>
										<th class="ppost_loaivientro text-white">Loại viện trợ</th>
										<th class="ppost_coquanpheduyet text-white">Cơ quan phê duyệt</th>
										<th class="ppost_doitacthuchien text-white">Đối tác thực hiện</th>
										<th class="ppost_tiendothuchien text-white">Tiến độ thực hiện</th>
										<th class="ppost_phantramtiendo text-white">Ước lượng % tiến độ</th>
