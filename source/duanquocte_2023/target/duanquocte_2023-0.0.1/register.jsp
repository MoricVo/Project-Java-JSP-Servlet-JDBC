...
<body>
	...
	%>
<form
			action="<c:url value='/dang-ky_them_donvitructhuoc?action=them_donvitructhuoc'/>"
	...
	<div class="card">
		<div class="card-body">
			...
			<div class="app-brand justify-content-center">
				<a href='<c:url value="/dang-ky?action=dangky_taikhoan"/>' class="app-brand-link gap-2"> <span
					...
					class="app-brand-text  text-body fw-bolder">Đăng ký tài
						khoản</span>
				</a>
			</div>
			<!-- /Logo -->
			...
			<p class="mb-4">Vui lòng điền đầy đủ thông tin để đăng ký tài
				khoản!</p>
			<div style="color: red;" class="red" id="baoLoi">
				<%=baoLoi%>
				<form id="formAuthentication" class="mb-3"
					action="<c:url value='/dang-ky?action=dang_ky_taikhoan'/>" method="post">
					<div class="mb-3">
