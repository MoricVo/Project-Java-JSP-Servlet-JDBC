...
import com.duan.mapper.bang_nhataitro_mapper;
import com.duan.model.bang_nhataitro_model;
import com.duan.paging.pageble;

public class bang_nhataitro_dao extends abstract_dao<bang_nhataitro_model> implements bang_nhataitro_interface_dao {

	@Override
	public List<bang_nhataitro_model> laytoanbodanhsach_dao(pageble pageble1) {
		StringBuilder sql=new StringBuilder("SELECT * FROM bang_nhataitro ");
		...
		if(pageble1.getOffset()!=null && pageble1.getLimit()!=null)
		{
			sql.append(" LIMIT  "+pageble1.getOffset()+" , "+pageble1.getLimit()+"  ");
			 ...
			 return truyvandulieu_generic(sql.toString(),new bang_nhataitro_mapper());
	}
