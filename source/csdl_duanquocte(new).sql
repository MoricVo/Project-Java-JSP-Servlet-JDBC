...
INSERT INTO `bang_coquanpheduyet` (`macoquanpheduyet`, `tencoquanpheduyet`, `ngaytao`, `ngaycapnhat`, `nguoitao`) VALUES
	...
	(7320, 'Lảnh sự quán Thụy Sĩ', '2023-05-23 01:57:57', NULL, 3010),
...
-- Dumping data for table csdl_duanquocte.bang_danhmuc: ~9 rows (approximately)
INSERT INTO `bang_danhmuc` (`madanhmuc`, `tendanhmuc`, `ngaytao`, `ngaycapnhat`, `nguoitao`) VALUES
	...
	(4319, 'Hóa vô cơ', '2023-05-23 01:56:39', '2023-06-04 07:47:47', 3010),
	(7033, 'Đời sống', '2023-04-05 06:31:56', '2023-06-24 07:47:47', 4),
	(7322, 'Giáo dục', '2023-04-05 06:35:12', '2023-06-04 07:47:48', 4),
	(8350, 'Du lịch', '2023-04-05 07:37:12', '2023-06-04 11:47:52', 8),
	(8871, 'Văn hóa', '2023-05-09 15:54:35', '2023-06-03 07:47:48', 8),
	(9660, 'Công nghệ', '2023-04-05 07:16:27', '2023-06-14 07:47:51', 1),
	(9752, 'Khoa học', '2023-04-06 05:18:39', '2023-06-04 07:47:51', 1),
	(9782, 'Nông nghiệp', '2023-04-06 05:44:55', '2023-06-04 07:47:49', 3),
	(9943, 'Ngôn ngữ', '2023-04-12 02:10:45', '2023-06-04 07:47:49', 7);
...
-- Dumping data for table csdl_duanquocte.bang_doitacthuchien: ~10 rows (approximately)
INSERT INTO `bang_doitacthuchien` (`madoitac`, `tendoitac`, `ngaytao`, `ngaycapnhat`, `nguoitao`) VALUES
	...
	(1378, 'Khu nghiên cứu thực nghiệm DH Cần Thơ', '2023-05-23 01:58:39', NULL, 3010),
...
-- Dumping data for table csdl_duanquocte.bang_duanquocte: ~33 rows (approximately)
INSERT INTO `bang_duanquocte` (`maduan`, `manguoidung`, `madonvitructhuoc`, `madanhmuc`, `manhataitro`, `maloaivientro`, `macoquanpheduyet`, `madoitacthuchien`, `tenduan_tiengviet`, `tenduan_tienganh`, `thanhvienthamgia`, `muctieuduan`, `noidungthuchien`, `thietbitaitro`, `kinhphiduannamtruoc`, `tongvonthuchien`, `vontaitro`, `vonvay`, `vonkhac`, `vondoiung`, `madonvitiente`, `thoigianthuchien`, `thoigianbatdau`, `thoigianketthuc`, `tiendothuchien`, `phantramtiendo`, `ngaytao`, `ngaycapnhat`, `trangthaiduan`, `trangthaiketthuc`, `donvitiente_vontaitro`, `donvitiente_vonvay`, `donvitiente_vonkhac`, `donvitiente_vondoiung`, `donvitiente_tongvonthuchien`) VALUES
	...
	(8069, 9524, 4, 7322, 5817, 3891, 8274, 3973, 'Tăng cường năng lực học tập cho các HS-SV bị thiệt thòi ở vùng ĐBSCL để có thể theo học tại Trường ĐHAG (PHE)', 'Strengthening learning capacity for students who are devastated in the gap to be able to study at AG University (PHE)', NULL, 'Cải thiện chất lượng giáo dục', 'Nghiên cứu tìm hướng giải quyết', 'Hiện tại chưa có.', '80000', 20000, 40000, 0, 60000, 0, 0, '', '2001-01-01 06:01:00', '2003-01-01 06:01:00', 'Đang triển khai', '75%', '2023-04-04 03:04:22', NULL, 0, 0, 'USD', 'VND', 'Euro', 'CNY', 'USD'),
	...
	(10086, 3103, 8, 8871, 3490, 8827, 2029, 9905, 'Định Hướng Giá Trị Văn Hóa Của Học Viên Đào Tạo Sĩ Quan Trong Các Trường Quân Đội', 'Cultural Value Orientation of Officer Training Trainees in Military Schools', NULL, 'tạo ra giá trị văn hóa', 'tạo ra gì đó', 'không', '20.000 USD', 4676850000, 20000000, 0, 4640000000, 123000000, 0, '2 năm, 10 tháng, 21 ngày', '2020-07-07 15:57:00', '2023-05-24 15:57:00', 'đang giải ngân', '10%', '2023-04-04 12:33:29', NULL, 0, 0, 'USD', 'VND', 'Euro', 'CNY', 'Euro'),
...
) ENGINE=InnoDB AUTO_INCREMENT=9807 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table csdl_duanquocte.bang_nguoidung: ~18 rows (approximately)
INSERT INTO `bang_nguoidung` (`manguoidung`, `madonvitructhuoc`, `machucvu`, `honguoidung`, `tennguoidung`, `sdt`, `diachi`, `gmail`, `matkhau`, `quyenhan`, `trangthai`, `anhdaidien`, `ngaylap`, `ngaycapnhat`, `maxacthuc_gmail`, `trangthaixacthuc`, `thoigianhieuluc`) VALUES
	...
	(2483, 5, 3, 'Võ', 'Minh Nguyệt', NULL, NULL, 'tankhoidev@gmail.com', 'f+PvshinZrpbz/twsZiDQ/qMD7I=', 'user', 1, NULL, NULL, NULL, '734921', 1, '2023-05-26 08:57:12'),
	...
	(6088, 7, 5, 'Võ ', 'con cac lo', '0912330462', 'Lấp Vò,Đồng Tháp', 'user_eng@gmail.com', 'lgqTdIGVt7EfShWIP7on6FbL9aM=', 'user', 1, '', NULL, NULL, '485878', 1, '2023-04-13 02:00:47'),
...
-- Dumping data for table csdl_duanquocte.bang_nhataitro: ~14 rows (approximately)
INSERT INTO `bang_nhataitro` (`manhataitro`, `tennhataitro`, `ngaytao`, `ngaycapnhat`, `nguoitao`) VALUES
	...
	(6580, 'BASF Tập đoàn đa quốc gia tại Thụy Sĩ', '2023-05-23 01:57:25', NULL, 3010),
